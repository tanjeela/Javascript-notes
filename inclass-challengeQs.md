...
Write a function that takes in a number of earth days, and returns the number of orbits the moon can 
...
Try writing the function again with the same inputs and outputs Without using a loop. 

(You may need to google some formulas!)
